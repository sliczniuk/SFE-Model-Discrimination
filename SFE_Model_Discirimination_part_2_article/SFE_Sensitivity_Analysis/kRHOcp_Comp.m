function [krhocp, k_eff] = kRHOcp_Comp(T, P, Z, RHO, CP, epsi, theta)
% kRHOcp_Comp - Effective thermal properties for packed bed
%
...
%
% Outputs:
%   krhocp - Effective thermal diffusivity  alpha_eff = k_eff/rhocp_eff  [m2/s]
%   k_eff  - Effective thermal conductivity  [W/(m·K)]
    ...
    k_eff     = epsi .* k_fluid + (1-epsi) .* k_solid;
    rhocp_eff = epsi .* RHO .* CP + (1-epsi) .* rhoSolid .* cpSolid;
